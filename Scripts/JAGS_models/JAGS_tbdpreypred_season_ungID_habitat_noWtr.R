  #'  ================================
  #'  Prey-Black Bear Latency Model 2
  ...
  #'  predator at camera sites. Excludes winter category from model owing to so 
  #'  few winter bear observations.
  #'  tbd ~ season + ungulateID + TRI
  #'  ================================
  
  cat(file = './Outputs/TimeBtwnDetections/tbd_season_ungID_habitat_noWtr.txt', "
              model{
