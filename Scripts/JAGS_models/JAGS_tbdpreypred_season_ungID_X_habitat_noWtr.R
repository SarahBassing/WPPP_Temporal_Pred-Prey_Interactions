...
#'  
#'  Test the effects of season, ungulate ID, terrain ruggedness, 
#'  and interactions between terrain and ungulate ID on the latency
#'  between detections of ungulates followed by predator at camera sites.
#'  Excludes winter category from model owing to so few winter bear observations.
#'  tbd ~ season + ungulateID + TRI + (ungulateID*TRI)
#'  ================================

cat(file = './Outputs/TimeBtwnDetections/tbd_season_ungID_X_habitat_noWtr.txt', "
          model{
